...
public class CommonConstant {
    ...
    public static final String PREFIX_USER_TOKEN_RETRY  = "PREFIX_USER_TOKEN_RETRY";
    ...
    public static final int VERIFY_SMS_EXPIRED_TIME = 1 ;


    public static final int EXCEPTION_TYPE_UNKNOWN = 0;

    public static final int EXCEPTION_TYPE_FRIENDLY = 1;

    public static final int EXCEPTION_TYPE_BADLY = 2;
}
